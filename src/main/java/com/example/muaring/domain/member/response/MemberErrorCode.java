...
public enum MemberErrorCode implements ErrorCode {
    ...
    INTEREST_NOT_FOUND(2009, HttpStatus.NOT_FOUND, "관심친구로 설정되어있지 않습니다."),

    // 409 에러
    METRICS_CONFLICT(20010, HttpStatus.CONFLICT, "핵심 필드가 존재할 수 없습니다."),
    DUPLICATE_NICKNAME(2011, HttpStatus.CONFLICT, "이미 사용중인 닉네임입니다."),
    MEMBER_CONFLICT(2012,HttpStatus.CONFLICT, "본인 계정에 대해 작업을 수행할 수 없습니다."),
    FOLLOW_ALREADY_EXISTS(2013, HttpStatus.CONFLICT, "이미 팔로우 중입니다."),
    FOLLOW_REQUEST_ALREADY_EXISTS(2014, HttpStatus.CONFLICT, "이미 팔로우 요청을 보냈습니다."),
    UNAUTHORIZED_ACTION(2015, HttpStatus.CONFLICT, "본인 요청만 승인할 수 있습니다"),
    ALREADY_INTERESTED(20016, HttpStatus.CONFLICT, "이미 관심친구로 설정되어 있습니다.");
